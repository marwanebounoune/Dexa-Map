...
class RapportSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        'descriptif_exploitation_rdc', 'descriptif_securiteAccInterphone', 'descriptif_securiteRes', 'descriptif_acces_mob_reduite', 'descriptif_composistion_cuisine', 'descriptif_composistion_sdb', 'descriptif_composistion_salon', 'descriptif_composistion_chambre', 'descriptif_donne_sur', 'descriptif_orientation',
