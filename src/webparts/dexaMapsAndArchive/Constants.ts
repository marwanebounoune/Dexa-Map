...
export const DISTANCE_END_FILTRAGE:number = 3000;//3km
...
export const urlPropertieArchive = "https://agroupma.sharepoint.com/sites/DEXA2022/Lists/Archive/DispForm.aspx?ID="